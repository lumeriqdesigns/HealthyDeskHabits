    ...
    <main>
      <section className="container max-w-[900px] py-16 md:py-20">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/desk-health" className="rounded-full bg-[#111315] px-6 py-3 text-sm font-bold text-white">
            Explore Desk Health
          </Link>
          <Link href="/search" className="rounded-full border border-[#dfe2dc] px-6 py-3 text-sm font-bold">
            Read the latest
          </Link>
        </div>
      </section>
